...
Conversion_table_BioMart = read_csv("Documents/Conversion_table_BioMart.csv")
...
##PCA plots
#Labeling Cohort 
dge_Combat_Cohort = DGEList(counts = cor_matrix_Combatseq_Cohort)
...
##PCA PLOTS
#Labeling Cohort 
dge_RNAseqMethod = DGEList(counts = cor_matrix_Combatseq_RNAseqMethod)
...
##PCA PLOTS
#Labeling Cohort 
dge_SeqInstrument = DGEList(counts = cor_matrix_Combatseq_SeqInstrument)
